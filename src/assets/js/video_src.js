class VideoPlayer extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <div className="video-title bg-dark text-white">
          {currentVideo.title}
        </div>
        ...
        <div className="carousel">
          <div className="wrap">
            <ul className="video-thumbs is-set">{videoThumbnails}</ul>
          </div>
        ...
        <div className="bg-primary text-dark text-center">
          {currentVideo.tool_url && (
            <a href={currentVideo.tool_url} className="btn btn-related-tool">
